...
class CreateTitleTable extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('title', array('engine' => 'InnoDB','collation' => 'utf8mb4_general_ci'));
        $table->addColumn('title', 'string', array('limit' => 255,'comment' => '前台大标题'))
